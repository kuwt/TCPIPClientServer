...
namespace google {
namespace protobuf {
template<> ::prototest::Foo* Arena::CreateMaybeMessage<::prototest::Foo>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace prototest {
...
inline ::std::string* Foo::release_bar() {
  ...
  clear_has_bar();
  return bar_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* Foo::release_baz() {
  ...
  clear_has_baz();
  return baz_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
